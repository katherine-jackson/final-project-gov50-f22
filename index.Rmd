...
---
##Final report
Introduction: This data analysis project sought to answer the following question: How does the US population's confidence in the executive branch of the federal government change as the inflation rate change? In starting this project, my hypothesis was that as the inflation rate rises, the confidence in the executive branch of the federal government falls. This hypothesis was based on the fact that high rates of inflation are not desirable


In a time where inflation in the United States is above average levels, this research question is matters because it is important to understand the on confidence. Especially because presidential elections are in 2024, the current (2022) inflation crisis will have characterized 
