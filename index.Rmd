...
I used two data sources for this project which I ultimately merged together using the year. The first is the General Social Survey (GSS) which was the source of my dependent variable. The second is the "Inflation, consumer prices for the United States" from the World Bank, but which I retrieved from the Federal Reserve Economic Data (FRED), which was the source of my independent variable. The GSS is a survey that collects information and keeps a historical record of the concerns, experiences, attitudes, and practices of residents of the United States. The FRED is a public database with macroeconomic indicators maintained by the Research division of the Federal Reserve Bank of St. Louis.
